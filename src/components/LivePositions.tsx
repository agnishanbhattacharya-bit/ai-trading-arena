  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-2 px-4 py-3 border-b border-border/20">
        <h3 className="font-medium text-xs text-foreground/70 uppercase tracking-wider">Portfolio</h3>
      </div>
      ...
      <div className="p-3 border-b border-border/20">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <p className={`font-mono font-semibold flex items-center gap-1 ${pnl >= 0 ? "text-profit" : "text-loss"}`}>
          ...
          <div>
            ...
            <p className="font-mono text-sm text-foreground/80">{positions.length}</p>
          </div>
        </div>
      </div>
                ...
                >
                  <div>
                    <div className="flex items-center gap-1.5">
                      <span className="font-mono font-medium text-sm text-foreground">{p.ticker}</span>
                      <span className={`text-[10px] font-mono px-1.5 py-0.5 rounded ${
                        p.position_type === "Long"
                          ? "bg-[hsl(var(--profit))]/10 text-profit"
